...
<head>
    ...
    <style>
        :root { --primary:#0b2447; --accent:#F28C28; }
                ...
                <div class="col-lg-5 col-12 d-flex align-items-center justify-content-center">
                    <div id="auth-left"
                        ...
                        <p class="text-center text-muted small mt-4 mb-0">
                            Dengan masuk, Anda menyetujui <a href="#" class="text-decoration-none">Syarat & Ketentuan</a>.
                        </p>
                    </div>
                </div>
                    ...
                    <div class="px-5" style="position:relative;z-index:1;max-width:560px;width:100%;">
                        ...
                        <div class="mt-4 d-flex flex-wrap gap-2">
                            <div class="d-flex align-items-center gap-2">
                                <span class="rounded-circle" style="width:8px;height:8px;background:var(--accent);display:inline-block;"></span>
                                <span class="text-muted small">Pilih tipe akun → lanjut isi form</span>
                            </div>
                            <div class="d-flex align-items-center gap-2">
                                <span class="rounded-circle" style="width:8px;height:8px;background:var(--primary);display:inline-block;"></span>
