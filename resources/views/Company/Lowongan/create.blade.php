...
@section('content')
    ...
    <div class="page-content">
        <div class="card">
            <div class="card-body">
                <form action="{{ url('company-lowongan') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <select name="employment_type" class="form-select @error('employment_type') is-invalid @enderror">
                            ...
                            <option value="contract" @selected(old('employment_type') === 'contract')>Kontrak</option>
                            <option value="internship" @selected(old('employment_type') === 'internship')>Magang</option>
                        </select>
                    ...
                    <div class="form-group mb-4">
                        ...
                        <input id="description-trix" type="hidden" name="description" value="{{ old('description') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <img id="imagePreviewContainer" src="#" alt="Preview Gambar"
                            style="display: none; max-width: 200px; height: auto; border: 1px solid #ddd; padding: 5px;">
                    </div>
