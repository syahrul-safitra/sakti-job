...
<body>
    <div class="header">
        @if ($user->photo)
            <img src="{{ public_path('FileUpload/' . $user->photo) }}" class="photo">
        @else
    ...
    <div class="container">
        ...
        <div class="row">
            <div style="width: 48%; float: left;">
                ...
                @foreach (json_decode($user->skills_json, true) ?: [] as $skill)
                    <span class="badge">{{ $skill }}</span>
                @endforeach
            </div>
            <div style="width: 48%; float: right;">
                <div class="section-title">Bahasa</div>
                @foreach (json_decode($user->languages_json, true) ?: [] as $lang)
