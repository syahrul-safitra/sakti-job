...
@php
    ...
    $summary = $u->summary ?? 'Fresh graduate Sistem Informasi dengan pemahaman yang baik dalam web development, analisis bisnis, dan pengelolaan data. Memiliki keterampilan komunikasi, pemecahan masalah, dan adaptasi yang tinggi. Berpengalaman dalam proyek akademik maupun magang.';
    ...
    if (!empty($u->skills)) {
        ...
        $skills = ['Sistem Informasi','ReactJS','Pemrograman JavaScript','Pemrograman PHP','CodeIgniter','Laravel Framework','Aplikasi Web','Microsoft Office','Pemasaran Digital'];
    }
...
<style>
    ...
    .profile-hero .shape{
        position:absolute; border-radius:999px; opacity:.9; filter: blur(.1px);
    }
    .profile-hero .shape.pink1{ width:160px; height:160px; right:-60px; top:-40px; background:#ff2aa1;}
    .profile-hero .shape.pink2{ width:120px; height:120px; right:20px; bottom:-60px; background:#ff2aa1;}
    .profile-hero .shape.blue1{ width:140px; height:140px; right:90px; top:40px; background:#1c4ea8; opacity:.45;}
    .profile-hero .shape.ring{
        width:140px; height:140px; right:40px; bottom:-70px;
        border:18px solid rgba(255,255,255,.08); background:transparent;
    }
    .section-card{
        border-radius: 14px;
    ...
    .profile-offcanvas { width: min(560px, 100vw); }
    .profile-offcanvas .offcanvas-header { padding: 22px 22px 14px; }
    .profile-offcanvas .offcanvas-body { padding: 18px 22px 22px; }
    .profile-offcanvas .form-label { font-weight: 600; }
    .profile-offcanvas .btn-primary { padding: .6rem 1.3rem; border-radius: 10px; }
</style>
    ...
    <div class="profile-hero p-4 p-md-5 text-white mb-4">
        ...
        <div class="row align-items-center position-relative g-0" style="z-index:2;">
            <div class="col-auto d-flex align-items-center me-3">
                ...
                @else
                    <div style="width:120px;height:120px;border-radius:50%;background:rgba(255,255,255,.15);display:flex;align-items:center;justify-content:center;font-weight:700;font-size:2rem;color:#fff;border:3px solid rgba(255,255,255,.3);box-shadow:0 8px 16px rgba(0,0,0,.15);">
            ...
            <div class="col">
                ...
                <div class="mt-3">
                    ...
                    <button type="button"
                        ...
                        data-bs-target="#offcanvasPersonalInfo"
                        aria-controls="offcanvasPersonalInfo">
                        Ubah
                    </button>
                </div>
            </div>
            ...
            <div class="card section-card mb-4">
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between mb-2">
                        ...
                        <a href="#" class="text-muted" title="Edit"
                           data-bs-toggle="offcanvas" data-bs-target="#offcanvasSummary" aria-controls="offcanvasSummary">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        ...
                        <a href="#" class="btn btn-outline-primary btn-sm"
                           data-bs-toggle="offcanvas" data-bs-target="#offcanvasExperience" aria-controls="offcanvasExperience"
            ...
            <div class="card section-card mb-4">
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        ...
                        <a href="#" class="btn btn-outline-primary btn-sm"
                           data-bs-toggle="offcanvas" data-bs-target="#offcanvasEducation" aria-controls="offcanvasEducation"
            ...
            <div class="card section-card mb-4">
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        ...
                        <a href="#" class="btn btn-outline-primary btn-sm"
                           data-bs-toggle="offcanvas" data-bs-target="#offcanvasCertifications" aria-controls="offcanvasCertifications"
                    ...
                    @foreach ($certs as $c)
                        <div class="d-flex justify-content-between align-items-start">
                            ...
                            <a href="#" class="text-muted" title="Edit"
                               ...
                               data-name="{{ $c['name'] }}" data-issuer="{{ $c['issuer'] }}" data-exp="{{ $c['exp'] }}">
                                <i class="bi bi-pencil"></i>
                            </a>
                        </div>
                        @if (!$loop->last)
            ...
            <div class="card section-card mb-4">
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        ...
                        <a href="#" class="btn btn-outline-primary btn-sm"
                           data-bs-toggle="offcanvas" data-bs-target="#offcanvasSkills" aria-controls="offcanvasSkills">
                            Tambah keahlian
                        </a>
                    </div>
            ...
            <div class="card section-card mb-4">
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        ...
                        <a href="#" class="btn btn-outline-primary btn-sm"
                           data-bs-toggle="offcanvas" data-bs-target="#offcanvasLanguages" aria-controls="offcanvasLanguages">
                            Tambah bahasa
                        </a>
                    </div>
        ...
        <div class="col-lg-4">
            <div class="card section-card">
                <div class="card-body">
                    ...
                    @php
                        $missing = [];
                        if (empty($summary)) $missing[] = 'Ringkasan';
                        if (empty($portfolio)) $missing[] = 'Portofolio';
                        if (count($skills) === 0) $missing[] = 'Keahlian';
                        if (count($experiences) === 0) $missing[] = 'Pengalaman';
                        if (count($educations) === 0) $missing[] = 'Pendidikan';
                        if (empty($u->photo)) $missing[] = 'Foto profil';
                        if (empty($u->file_cv)) $missing[] = 'CV';
                    @endphp
...
<div class="offcanvas offcanvas-end profile-offcanvas" tabindex="-1" id="offcanvasSummary" aria-labelledby="offcanvasSummaryLabel">
...
<div class="offcanvas offcanvas-end profile-offcanvas" tabindex="-1" id="offcanvasExperience" aria-labelledby="offcanvasExperienceLabel">
    <div class="offcanvas-header">
    ...
    <div class="offcanvas-body">
        <form action="{{ url('edit-profile-user/' . optional($user)->id) }}" method="POST" id="formExperience">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="experience_title" name="experience_title" placeholder="Contoh: Software Engineer">
            </div>
            <div class="mb-3">
                <label class="form-label">Perusahaan</label>
                <input type="text" class="form-control" id="experience_company" name="experience_company" placeholder="Nama perusahaan">
            </div>
            <div class="mb-3">
                <label class="form-label">Periode</label>
                <input type="text" class="form-control" id="experience_period" name="experience_period" placeholder="Contoh: 2022 - Sekarang">
            </div>
            <div class="mb-3">
                <label class="form-label">Deskripsi</label>
                <textarea class="form-control" id="experience_desc" name="experience_desc" rows="4" placeholder="Ringkas deskripsi pekerjaan"></textarea>
            </div>
            <div class="d-flex justify-content-end gap-2">
                <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="offcanvas">Batal</button>
                <button type="submit" class="btn btn-primary">Simpan</button>
...
<div class="offcanvas offcanvas-end profile-offcanvas" tabindex="-1" id="offcanvasEducation" aria-labelledby="offcanvasEducationLabel">
    <div class="offcanvas-header">
    ...
    <div class="offcanvas-body">
        <form action="{{ url('edit-profile-user/' . optional($user)->id) }}" method="POST" id="formEducation">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="education_degree" name="education_degree" placeholder="Contoh: Sarjana Sistem Informasi">
            </div>
            <div class="mb-3">
                <label class="form-label">Institusi</label>
                <input type="text" class="form-control" id="education_school" name="education_school" placeholder="Nama kampus/sekolah">
            </div>
            <div class="mb-3">
                <label class="form-label">Periode</label>
                <input type="text" class="form-control" id="education_period" name="education_period" placeholder="Contoh: Selesai 2025">
            </div>
            <div class="mb-3">
                <label class="form-label">Deskripsi</label>
                <textarea class="form-control" id="education_desc" name="education_desc" rows="4" placeholder="Ringkas deskripsi pendidikan"></textarea>
            </div>
            <div class="d-flex justify-content-end gap-2">
                <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="offcanvas">Batal</button>
                <button type="submit" class="btn btn-primary">Simpan</button>
...
<div class="offcanvas offcanvas-end profile-offcanvas" tabindex="-1" id="offcanvasCertifications" aria-labelledby="offcanvasCertificationsLabel">
    <div class="offcanvas-header">
    ...
    <div class="offcanvas-body">
        <form action="{{ url('edit-profile-user/' . optional($user)->id) }}" method="POST" id="formCertifications">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="cert_name" name="cert_name" placeholder="Contoh: AWS Certified">
            </div>
            <div class="mb-3">
                <label class="form-label">Penerbit</label>
                <input type="text" class="form-control" id="cert_issuer" name="cert_issuer" placeholder="Contoh: Amazon Web Services">
            </div>
            <div class="mb-3">
                <label class="form-label">Masa berlaku / kedaluwarsa</label>
                <input type="text" class="form-control" id="cert_exp" name="cert_exp" placeholder="Contoh: Kedaluwarsa: Jun 2025">
            </div>
            <div class="d-flex justify-content-end gap-2">
                <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="offcanvas">Batal</button>
                <button type="submit" class="btn btn-primary">Simpan</button>
...
<div class="offcanvas offcanvas-end profile-offcanvas" tabindex="-1" id="offcanvasSkills" aria-labelledby="offcanvasSkillsLabel">
    <div class="offcanvas-header">
    ...
    <div class="offcanvas-body">
        <form action="{{ url('edit-profile-user/' . optional($user)->id) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="skills_text" placeholder="Contoh: Laravel, React" value="{{ implode(', ', $skills) }}">
            </div>
            <div class="d-flex justify-content-end gap-2">
                <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="offcanvas">Batal</button>
                <button type="submit" class="btn btn-primary">Simpan</button>
...
<div class="offcanvas offcanvas-end profile-offcanvas" tabindex="-1" id="offcanvasLanguages" aria-labelledby="offcanvasLanguagesLabel">
    <div class="offcanvas-header">
    ...
    <div class="offcanvas-body">
        <form action="{{ url('edit-profile-user/' . optional($user)->id) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="languages_text" placeholder="Contoh: Indonesia, Inggris" value="{{ implode(', ', $languages) }}">
            </div>
            <div class="d-flex justify-content-end gap-2">
                <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="offcanvas">Batal</button>
                <button type="submit" class="btn btn-primary">Simpan</button>
...
<div class="offcanvas offcanvas-end profile-offcanvas" tabindex="-1" id="offcanvasPreferences" aria-labelledby="offcanvasPreferencesLabel">
    <div class="offcanvas-header">
...
=========================== --}}
<div class="offcanvas offcanvas-end profile-offcanvas" tabindex="-1"
     id="offcanvasPersonalInfo" aria-labelledby="offcanvasPersonalInfoLabel">
    ...
    <div class="offcanvas-body">
        ...
        <form action="{{ url('edit-profile-user/' . optional($user)->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="row g-3">
                ...
                <div class="col-12 mt-2">
                    ...
                    <input type="text" class="form-control" name="portfolio_url"
                           value="{{ old('portfolio_url', $portfolio) }}"
                           placeholder="https://...">
                    @error('portfolio_url')
                        <div class="text-danger small mt-1">{{ $message }}</div>
                    @enderror
                ...
                <div class="col-12 mt-2">
                    ...
                    <input type="text" class="form-control" name="full_name"
                           value="{{ old('full_name', optional($user)->full_name) }}"
